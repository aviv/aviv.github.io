...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlForm = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    // add 'HTTP' prefix if it's not already there
	    if (!/https?\:\/\//.test(url)) {
	      url = 'http://' + url;
	    }
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'submit', value: 'Shorten' })
	    );
	  }
	});
	...
	var Url = React.createClass({
	  ...
	  fullShortUrl: function fullShortUrl(short_url) {
	    return 'http://' + window.location.host + '/' + short_url;
	  },
	  urlOrNothing: function urlOrNothing() {
	    if (this.props.data.url) {
	      var shortUrl = this.fullShortUrl(this.props.data.shortened_url);
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(
	...
	var UrlBox = React.createClass({
	  ...
	  handleURLSubmit: function handleURLSubmit(url) {
	    $.ajax({
	      url: this.props.url,
	      dataType: 'json',
	      type: 'POST',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Url, { data: this.state.data })
	    );
	  }
	});

	React.render(React.createElement(UrlBox, { url: '/url/' }), document.getElementById('react-app'));
